...
export const comprobarSiLugarEstaVisitado = async (placeId) => {
    try {
        const res = await fetch('https://tourtales.3.us-1.fl0.io/api/lugarVisitado/obtenerLugarVisitadoIdlugar', {
            method: 'POST',
            headers: {
...
export const handleVisitedClick = async (e) => {
    ...
    const res = await fetch('https://tourtales.3.us-1.fl0.io/api/lugarVisitado/crearLugarVisitado', {
        method: 'POST',
        headers: {
        'Content-Type': 'application/json'
        },
